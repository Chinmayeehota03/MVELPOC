...
import com.assignment.resolver.DSLResolver;
import com.assignment.resolver.KeyResolver;
	        ...
	        listOfDslKeyword.stream()
	                .forEach(
	                        dslKeyword -> {
	                            ...
	                            DSLResolver resolver = kResolver.getResolver(keyResolver).get();
